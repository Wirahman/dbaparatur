...
?>
    <div class="alert alert-block alert-info">
        ...
        <i class="icon-ok blue"></i>
        Saat ini ada <u><a href="<?= site_url() ?>/kegiatan/index/nofilter/"><?= $num_kegiatan ?> Kegiatan</a></u> di Tahun
        Anggaran <?= $this->session->userdata('processing_year') ?>
    </div>
            ...
            <div class="infobox infobox-green  ">
                ...
                <div class="infobox-data">
                    <span class="infobox-data-number"
                          style="font-size:12px;"><strong>Rp <?= $this->common->number_format_ind($anggaran_realisasi_bulan_ini, true) ?></strong></span>
