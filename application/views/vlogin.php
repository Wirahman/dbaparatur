...
<head>
    ...
    <meta name="description" content="Pusdiklat - SKP"/>
                ...
                <div class="login-container">
                    ...
                    <div class="position-relative">
                        <div id="login-box" class="login-box visible widget-box no-border center">
                            <div class="widget-body">
                                <div class="widget-main">
                                    <h4 class="header black lighter bigger">
                                        <strong>Database Aparatur Dukcapil Daerah</strong>
                                    </h4>
                                    <img style="max-width: 25%" src="<?php echo base_url() ?>assets/img/logo_main.png"/>
                                        ...
                                        <fieldset>
                                            ...
                                            <label class="block clearfix">
                                                        <span class="block input-icon input-icon-right">
                                                            <input type="text" class="form-control" placeholder="NIP Pengguna" id="nip" name="nip" autocomplete="off"/>
                                                            <i class="icon-user"></i>
                                                        </span>
                                            </label>
                            ...
                            <h4 class="white">&copy; KEMENTERIAN DALAM NEGERI REPUBLIK INDONESIA.</h4>
