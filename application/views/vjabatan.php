	...
	<div class="form-horizontal" role="form">
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
                ...
                <div class="form-group">
			<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Nama Atasan</label>
			<div class="col-sm-8">
                            <input  type="text" size="30" rel="tooltip" title="nama Jabatan"   id="id_atasan" placeholder="Nama Atasan"  /> <span style="font-size:12px; color:red;">*</span> <br>
...
<!--                     <span class="block input-icon input-icon-right">
                                            <select id="deskripsiedit" name="deskripsiedit" class="select2style" style="width: 80%;">
                                                    <option value="0">Pilih Jabatan</option>
                                                <?php foreach ($comjabatan as $dj): ?>
                                                    <option value="<?php echo $dj->id; ?>" selected="deskripsiedit"><?php echo $dj->deskripsi; ?></option>
                                                <?php endforeach; ?>
                                            </select>
			...
			<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Nama Atasan</label>
                    <div class="col-sm-8">
                        <input type="text" onkeypress="return entsubFilter(event)" size="30" id="" name="deskripsiedit"  autocomplete="off" />
                    </div>
                </div>
...
<div class="row">
  <div class="col-xs-12">
	...
	<td align="center">
        ...
        <td>
             <?php echo ucfirst($jabatan->id_atasan);?>
        </td>
	<td>
            ...
            <button id="" class="btn btn-primary btn-xs" rel="tooltip" data-placement="bottom">
