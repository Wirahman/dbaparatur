...
<?php $this->load->view('vheader'); ?>
    ...
    <div class="widget-header"><h5><i class="icon-certificate"></i>Hasil Penilaian Prestasi Kerja Tahun <?php echo $pk->tahun . " (SKP ke-" . $pk->penilaian_ke . ")"; ?></h5>
    </div>
                    ...
                    <div class="tabbable">
                        ...
                        <div class="tab-content" style="min-height: 250px;">
                            <div id="prestasikerja" class="tab-pane in active">
                                ...
                                <?php if ($pk->status >= 4) { ?>
                                    <div>
                                        <button id="setujuPenilaian" class="btn btn-primary btn-sm <?php echo ($pk->status == 4) ? '' : 'hide'; ?>" rel="tooltip"
                                                title="Setuju Hasil Penilaian" data-placement="bottom">
                                            <i class="icon-ok"></i>
                                            Setuju Hasil Penilaian
                                        </button>
                                        <button id="keberatan" class="btn btn-danger btn-sm <?php echo ($pk->status == 4) ? '' : 'hide'; ?>" rel="tooltip"
                                                title="Ajukan Keberatan" data-placement="bottom">
                                    ...
                                    <h5 class='<?php echo $pk->tanggal_dibuat_penilai == NULL ? 'hide' : ''; ?>'>Dibuat oleh Pejabat Penilai pada
                                        tanggal <?php echo date_format(date_create($pk->tanggal_dibuat_penilai), "d/m/Y H:i:s"); ?></h5>
                                    <h5 class='<?php echo $pk->tanggal_diterima_yang_dinilai == NULL ? 'hide' : ''; ?>'>Diterima oleh Pegawain yang diniai pada
                                        tanggal <?php echo date_format(date_create($pk->tanggal_diterima_yang_dinilai), "d/m/Y H:i:s"); ?></h5>
                                    <h5 class="<?php echo $pk->tanggal_diterima_atasan_penilai == NULL ? 'hide' : ''; ?>">Diterima oleh Atasan Pejabat Penilai pada
                                        tanggal <?php echo date_format(date_create($pk->tanggal_diterima_atasan_penilai), "d/m/Y H:i:s"); ?></h5>
                                <?php } ?>
                                <br/>
                            </div>
                            <!-- end tab -->
                                    ...
                                    <table id="realisasitable" class="table table-striped table-bordered">
                                        ...
                                        foreach ($tugas_jabatan as $ktj):
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <?php if (isset($ktj->realisasi_angka_kredit)): echo $ktj->realisasi_angka_kredit;
                                                    else: echo '-'; endif; ?>
                                                </td>
                                                <td align="center">
                                                    <a class="green edit_data" data-toggle="modal" data-target="#realisasi_<?php echo $ktj->id; ?>"
                                                       data-id="<?php echo $ktj->id; ?>" rel="tooltip">
                                                        <?php if (isset($ktj->realisasi_kuantitas)): echo $ktj->realisasi_kuantitas;
                                                        else: echo '-'; endif; ?>
                                                    </a>
                                                </td>
                                                <td align="center">
                                                ...
                                                <td align="left">
                                                    <?php if (isset($ktj->realisasi_kualitas)): echo $ktj->realisasi_kualitas;
                                                    else: echo '-'; endif; ?>
                                                </td>
                                                <td align="center">
                                                    <?php if (isset($ktj->realisasi_waktu)): echo $ktj->realisasi_waktu;
                                                    else: echo '-'; endif; ?>
                                                </td>
                                                <td align="center">
                                                    <?php echo $ktj->satuan_waktu; ?>
                                                ...
                                                <td align="center">
                                                    <?php if (isset($ktj->realisasi_biaya)): echo number_format($ktj->realisasi_biaya, 0, ",", ".");
                                                    else: echo '-'; endif; ?>
                                                </td>

                                                <td align="center">
                                                    <?php if (isset($ktj->penghitungan)): echo $ktj->penghitungan;
                                                    else: echo '0'; endif; ?>
                                                </td>
                                                <td align="center">
                                                    <?php if (isset($ktj->nilai_capaian_skp)): echo $ktj->nilai_capaian_skp;
                                                    else: echo '0'; endif; ?>
                                                </td>
                                                <td align="center">
                                                    <?php
                                                    ...
                                                    if ($pk->status == 3):
                                                        ?>
                                                        <button id="penilaianKualitas" value="<?php echo $ktj->id; ?>"
                                                                class="penilaianKualitas btn btn-primary btn-xs padding-20" rel="tooltip" title="Isi penilaian kualitas/mutu"
                                        ...
                                        foreach ($tugas_tambahan as $tt):
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <?php if (isset($tt->nilai_capaian_skp)): echo $tt->nilai_capaian_skp;
                                                    else: echo '0'; endif; ?>
                                                </td>
                                                <td align="center">
                                                    <?php
                                                    ...
                                                    if ($pk->status == 3):
                                                        ?>
                                                        <button id="penilaianTugasTambahan" value="<?php echo $tt->id; ?>"
                                                                class="penilaianTugasTambahan btn btn-primary btn-xs padding-20" rel="tooltip"
                                                                title="Isi penilaian tugas tambahan/kreatifitas" data-placement="bottom">
                                                            <i class="icon-pencil"></i>
                                                        </button>
                                                        <?php
                                                    endif;
                                        ...
                                        foreach ($kreatifitas as $kr):
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <?php if (isset($kr->nilai_capaian_skp)): echo $kr->nilai_capaian_skp;
                                                    else: echo '0'; endif; ?>
                                                </td>
                                                <td align="center">
                                                    <?php
                                                    ...
                                                    if ($pk->status == 3):
                                                        ?>
                                                        <button id="penilaianTugasTambahan" value="<?php echo $kr->id; ?>"
                                                                class="penilaianTugasTambahan btn btn-primary btn-xs padding-20" rel="tooltip"
                                                                title="Isi penilaian tugas tambahan/kreatifitas" data-placement="bottom">
                                                            <i class="icon-pencil"></i>
                                                        </button>
                                        ...
                                        <tr class="bolder">
                                            ...
                                            <td align="center">
                                                <?php if (isset($pk->rata_capaian_skp)): echo number_format($pk->rata_capaian_skp, 2, ",", ".");
                                                else: echo '0';endif; ?>
                                            </td>
                                        </tr>
                                        </tbody>
                                ...
                                <div class="table-responsive overflow-auto">
                                    <table id="realisasitable" class="table table-bordered table-striped table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-center"><?php if (isset($pk->jumlah_perilaku_kerja)): echo $pk->jumlah_perilaku_kerja;
                                                else: echo "0"; endif; ?></td>
                                            <td class="align-center"></td>
                                        </tr>
                                        <tr>
                                            <td class="align-right">Nilai rata-rata</td>
                                            <td class="align-center"><?php if (isset($pk->rata_perilaku_kerja)): echo $pk->rata_perilaku_kerja;
                                                else: echo "0"; endif; ?></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-center"><?php if (isset($pk->nilai_perilaku_kerja)): echo $pk->nilai_perilaku_kerja;
                                                else: echo "0"; endif; ?></td>
                                            <td class="align-center"></td>
                                        </tr>
                                        </tfoot>
    ...
    <div class="modal fade" id="ModalKeberatan" role="dialog">
        <div class="modal-dialog">
            <div class="widget-main">
                <form id="FormKeberatan" method="post">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h3>Keberatan</h3>
                        </div>
                        <div class="modal-body row">
                            <textarea id="input_keberatan" name="input_keberatan" style="width: 100%; min-height: 250px;" class="overflow-auto" placeholder="..."></textarea>
                        </div><!-- modal body -->
                        <div class="modal-footer">
                            <button id="submitKeberatan" class="btn btn-primary btn-sm" rel="tooltip" title="Laporkan Keberatan" data-placement="bottom">
                                <i class="icon-ok"></i>
                                Kirim Keberatan
                            </button>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            // Submit Keberatan
            $("#submitKeberatan").click(function () {
                $.ajax({
                    type: 'POST',
                    url: siteUrl + '/skp/submit_keberatan/<?php echo $pk->id;?>',
                    data: {
                        'input_keberatan': $("#input_keberatan").val(),
                    },
                    dataType: 'json',
            ...
            // Setuju Penilaian
            $("#setujuPenilaian").click(function () {
                $.ajax({
                    type: 'POST',
                    url: siteUrl + '/skp/selesai_skp/<?php echo $pk->id;?>',
                    data: {},
                    dataType: 'json',
                    success: function (data) {
                        location.reload();
            ...
            $(".dokumen").click(function () {
                window.open(siteUrl + '/skp/download_dokumen/' + $('#dokumen').val(), '_blank');
                return false;
            });
