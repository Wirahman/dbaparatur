                    ...
                    <div class="widget-body">
                        <div class="form-horizontal" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <select id="nama_jabatan" name="nama_jabatan" style="width: 245px;">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" size="30" rel="tooltip" title="nama Kegiatan" id="kegiatan" placeholder="Nama Kegiatan"/> <span
                        ...
                        <div class="form-horizontal" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select id="nama_jabatan1" name="nart" style="width: 245px;">
                                        <option value='' selected='selected'> -- Pilih Jabatan --</option>
                                        <?php foreach ($nama_jabatan->result() as $opt)
                                            echo "<option value='" . $opt->id . "'>  " . $opt->deskripsi . " </option>";
                                        ?>
                                    </select>
                                    <input type="text" name="nama_jab1" id="nama_jab1" value="<?= $opt->deskripsi ?>" readonly/>
